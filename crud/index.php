...
// if you summit data by using form
//$sql = "INSERT INTO `demo` (`name`, `dest`) VALUES ('$email', '$password')";
$result = mysqli_query($conn, $sql);
...
<div class="modal fade" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="viewModalLabel">Edit this Note</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <form action="/crud/index.php" method="POST">
          <div class="modal-body">
            <input type="hidden" name="snoView" id="snoView">
            <div class="form-group">
              <label for="title">Note Title</label>
              <input type="text" class="form-control" id="titleView" name="titleEdit" aria-describedby="emailHelp">
            </div>

            <div class="form-group">
              <label for="desc">Note Description</label>
              <textarea class="form-control" id="descriptionView" name="descriptionView" rows="3"></textarea>
            </div> 
          </div>
          <div class="modal-footer d-block mr-auto">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <?php
        // note :
        // show the about nav link if a = true;
        // hide the about nav link if a = false;
        $a= false;
        if($a==true){
        echo "
        <li class='nav-item'>
    ...
    Array.from(edits).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        console.log(e.target.parentNode.parentNode);
         ...
         action = tr.getElementsByTagName("td")[2].innerText;
